# -*- coding: utf-8 -*-
"""
Created on Sun Jul  9 08:38:15 2017
...
path = CreateWinPath(['AllStateFarmDistractedDrivers','driver_imgs_list.csv'])    
print(path)
...
df = pd.read_csv(CreateWinPath(['AllStateFarmDistractedDrivers','driver_imgs_list.csv']))
print(df.columns.values)
print(df.classname[:10], df.classname[:10], df.img[:10])

f = open(CreateWinPath(['AllStateFarmDistractedDrivers','driver_imgs_list.csv']), 'r')
line = f.readline()
dr = dict()
clss = dict()
while (1):
...
print(clss.keys())
print(dr['img_13786.jpg'])

z = ["cache"]
y = CreateWinPath(z)
print(os.path.isdir(y))
print(y)
...
def get_driver_data():
    ...
    clss = dict()
#    path = os.path.join('..', 'input', 'driver_imgs_list.csv')
#    C:\Users\echtpar\Anaconda3\KerasProjects\Keras-CNN-Tutorial\AllStateFarmDistractedDrivers\driver_imgs_list.csv
    path = CreateWinPath('AllStateFarmDistractedDrivers','driver_imgs_list.csv')
    dr = pd.read_csv(CreateWinPath(['AllStateFarmDistractedDrivers','driver_imgs_list.csv']))
    print(dr.head())
