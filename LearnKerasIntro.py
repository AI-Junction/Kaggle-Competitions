...
plt.pcolor(X_train[5].reshape(28,28))
...
y_pred = model.predict_classes(X_test[0:25])
...
for i, ax in enumerate(axes.flat):
    ...
    ax.text(0.95, 0.05, 'n={0}{1}'.format(y_test[i], model.predict_classes(X_test[i:i+1])), ha='right', 
