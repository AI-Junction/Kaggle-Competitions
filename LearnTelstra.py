# -*- coding: utf-8 -*-
"""
Created on Mon Apr 10 18:32:47 2017
...
train_orig = pd.read_csv('C:\\Users\\echtpar\\Anaconda3\\KerasProjects\\Keras-CNN-Tutorial\\AllTeslaData\\train.csv', header=0)
test_orig = pd.read_csv('C:\\Users\\echtpar\\Anaconda3\\KerasProjects\\Keras-CNN-Tutorial\\AllTeslaData\\test.csv', header=0)
severity_type = pd.read_csv('C:\\Users\\echtpar\\Anaconda3\\KerasProjects\\Keras-CNN-Tutorial\\AllTeslaData\\severity_type.csv', header=0)
log_feature = pd.read_csv('C:\\Users\\echtpar\\Anaconda3\\KerasProjects\\Keras-CNN-Tutorial\\AllTeslaData\\log_feature.csv', header=0)
event_type = pd.read_csv('C:\\Users\\echtpar\\Anaconda3\\KerasProjects\\Keras-CNN-Tutorial\\AllTeslaData\\event_type.csv', header=0)
resource_type = pd.read_csv('C:\\Users\\echtpar\\Anaconda3\\KerasProjects\\Keras-CNN-Tutorial\\AllTeslaData\\resource_type.csv', header=0)
