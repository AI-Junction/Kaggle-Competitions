...
file_path = "C:\\Users\\echtpar\\Anaconda3\\KerasProjects\\Keras-CNN-Tutorial\\AllTitanicData\\titanic.xls"
...
clf = KMeans(n_clusters = 2, max_iter = 500)
clf.fit(X)
...
for i in range(len(X)):
    ...
    print('now check y[i] = ', y[i] )
    print('now check y_dash[i] = ', prediction )
    #print(y[i])
