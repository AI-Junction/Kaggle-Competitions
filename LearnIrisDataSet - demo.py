...
filepath = "C:\\Users\\echtpar\\Anaconda3\\KerasProjects\\Keras-CNN-Tutorial\\AllDiabetesPimaData\\diabetes.csv"

col_names=['pregnant', 'glucose', 'bp', 'skin', 'insulin', 'bmi', 'pedegree', 'age', 'label']
#pima = pd.read_csv(filepath, header = [0], names = col_names)
...
col_names1=['Pregnancies','Insulin', 'BMI', 'Age']
X = pima[col_names1]
X.head()
