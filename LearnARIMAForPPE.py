...
train_record = train.iloc[0]
#train_record = train[:1]
#print(train_record['Page'].unique())
#print(train_record.columns.values)
...
#print(train_record.columns[-50:])
#print(train_flattened.shape)
#print(train_flattened[:10])
#print(train.shape)
#print(train_flattened['Page'].value_counts())
#print(train_flattened.columns.values)
#print(train_flattened.columns)
#print(type(train_flattened))
...
#print(train_flattened_sorted.Visits)
#print(train_flattened_sorted.index)
#plt.figure(figsize = (16,8))
#print(train_flattened_sorted.index[:-1])
#print(range(train_flattened_sorted.shape[0]))
plt.figure(figsize = (16,8))
...
#train_flattened.plot.scatter(train_flattened['Visits'], train_flattened['Visits'])

#train_flattened_sorted.plot.scatter(np.arange(train_flattened_sorted.shape[0]+1), train_flattened_sorted['Visits'])
#ax = plt.subplot(1,1,1)
#ax = train_flattened.plot.scatter(train_flattened.date.dt.date, 'Visits')
#plt.show()
#print(np.arange(50))
#print(len(train_flattened_sorted['Visits']), len(np.arange(50)))
#print(train_flattened_sorted[-10:])

#print(train_flattened.date)
#print(train_flattened.columns)
#print(train_flattened.date.dt.date)
...
#print(train_flattened.month.unique())
...
print(train_day)
print(train_flattened.day.unique())
...
#times_series_means["diff"] = np.nan
#times_series_means.loc[1:, "diff"] = (times_series_means.loc[1:, "Visits"].as_matrix() - times_series_means.loc[:len(times_series_means)-2, "Visits"].as_matrix())
#
#print(len(times_series_means.loc[1:, "diff"]))
#print(len(times_series_means.loc[1:, "diff"].as_matrix()))
#print(len(times_series_means.loc[:len(times_series_means)-1, "diff"].as_matrix()))
#print(len(times_series_means)-1)
#
#
#print(times_series_means.loc[1:, "diff"])
#print(times_series_means.loc[:len(times_series_means)-2, "diff"])
#
#
#print(times_series_means['diff'], times_series_means['Visits'])
...
df_date_index.plot(figsize=(15, 6))
plt.show()
